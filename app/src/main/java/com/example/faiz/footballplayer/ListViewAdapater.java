package com.example.faiz.footballplayer;
...
public class ListViewAdapater extends ArrayAdapter<PlayerItem> {

    private List<PlayerItem> playerItemList;

    private Context context;

    public ListViewAdapater(List<PlayerItem> playerItemList, Context context) {
